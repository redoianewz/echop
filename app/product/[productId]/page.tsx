...
export default function page({params: { productId }}:any) {
  ...
  const handleAddToWishlist = () => {
    ...
    fetch('http://localhost:5001/api/wishlist', {
      ...
      .then((res) => res.json())
      .then((data) => {
        console.log('Add to wishlit:', data);
      })
      .catch((error) => {
        console.error('Error:', error);
      });
    ...
    <div className="py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center space-x-2 text-gray-400 text-sm">
          ...
          <a href="#" className="hover:underline hover:text-black">Electronics</a>
          <span>
            <svg className="h-5 w-5 leading-none text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
        ...
        <div key={index} className="w-1/2 p-2 sm:w-1/4">
          ...
          >
            <img src={'http://localhost:5001/images/products/' +thumbnail } alt="" className="object-cover w-full lg:h-32" />
              ...
              <h1 className=" text-2xl font-bold text-orange-500 dark:text-orange-500">{product.category_name}</h1>
            </div>
              ...
              <div className="w-full px-4 md:w-1/2 ">
                  <div className="lg:pl-20">
                      <div className="pb-6 mb-8 border-b border-gray-200 dark:border-gray-700">
                          <span className="text-lg font-medium text-orange-500 dark:text-orange-500">New</span>
                          ...
                          <div className="p-4 mb-8 border border-gray-300 dark:border-gray-700">
                              <h2 className="mb-4 text-xl font-semibold dark:text-gray-400">Real time <span
                                      className="px-2 bg-teal-500 text-gray-50">26</span>
                              ...
                              <div className="w-full bg-gray-200 rounded-full h-2.5  dark:bg-gray-600">  
                                  ...
                                  <div className="bg-teal-600 dark:bg-teal-400 h-2.5 rounded-full" 
                                  style={{width: `${product.quantity > 100 ? product.quantity / 10 : product.quantity}%`}}>
                          ...
                          <p className="inline-block text-2xl font-semibold text-gray-700 dark:text-gray-400 ">
                              ...
                              <span
                                  className="text-base font-normal text-gray-500 line-through dark:text-gray-400">{product.regular_price} dh</span>
                          </p>
                      </div>                     
                        <div className="mb-8">                                                    
  ...
  {product.attributes && product.attributes.map((attr, index) => (
      ...
      {attr.name.toLowerCase() === 'color' ? (
        ...
        <div className="flex flex-wrap -mb-2">
          {attr.values.map((value, valueIndex) => (       
            <div className="inline-flex items-center">
              <label key={valueIndex} className="relative flex items-center p-3 rounded-full cursor-pointer" >
              <input
        ...
        <div className="flex flex-wrap -mb-2">
          {attr.values.map((value, valueIndex) => (         
            <div className="inline-flex items-center">
              <label key={valueIndex}   className="relative flex items-center p-3 rounded-full cursor-pointer" >
              <input name={attr.name} type="radio" value={value}
                ...
                id={value} onChange={()=>setSelectsize(value)} /> 
              <span
                className="absolute transition-opacity opacity-100 text-lg font-medium top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 text-black">
                {value}
              </span>
              </label>
            </div>            
   ...
   {selectedColor && (
        <p className="text-lg font-medium mt-4">Selected Color: {selectedColor}</p>
      )} 
      {selectsize && (
        <p className="text-lg font-medium mt-4">Selected Size: {selectsize}</p>
      )}
</div>
                        ...
                        <div className="flex flex-wrap items-center ">
                          ...
                          <div className="mb-4 mr-4 lg:mb-0">
                              <button
                                  ...
                                  className="w-full h-10 p-2 mr-4 bg-teal-500 dark:text-gray-200 text-gray-50 hover:bg-teal-600 dark:bg-teal-600 dark:hover:bg-teal-500">
                                  Buy Now</button>
                          </div>
                          <Link href="/cart">
                          <div className="mb-4 mr-4 lg:mb-0">
