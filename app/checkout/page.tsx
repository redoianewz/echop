...
export default function Checkout() {
  ...
  useEffect(() => {
    ...
    getShopignCart();
  }, [uuid]); // Removed the condition from the dependency array
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3">
      <div className="md:col-span-2 col-span-1 space-y-8 px-4 md:px-12">
      ...
      <div className="col-span-1 bg-white mt-2 mr-2 mb-3 p-4">
                      ...
                      <li className="grid grid-cols-6 gap-2 border-b-1 mb-2">
                        ...
                        <div className="col-span-2 pt-3">
                          <div className="flex items-center space-x-2 text-sm justify-between">
                            ...
                            <span className="text-orange-500 font-semibold inline-block">
