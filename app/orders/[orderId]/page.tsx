    ...
    const getOrders = async () => {
      try {
        const response = await fetch(
          `${apiURL}/api/checkout/${user?.id}/${orderId}`
        ); // add orderId to the URL
        if (!response.ok) {
    ...
    <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
      <div>
        <div className="flex justify-start item-start space-y-2 flex-col">
          <h1 className="text-3xl dark:text-gray-800 lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">
            Order #AE12{orders.orderId}
          </h1>
          <p className="text-base dark:text-gray-600 font-medium leading-6 text-gray-600">
            {orders.created_at}
          </p>
        </div>
        ...
        <div className="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
          <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
            <div className="flex flex-col justify-start items-start dark:bg-gray-50 bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
              <p className="text-lg md:text-xl dark:text-gray-800 font-semibold leading-6 xl:leading-5 text-gray-800">
                Customer’s Cart
              </p>
              {orders.items &&
                  ...
                  <div className="mt-4 md:mt-6 flex flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
                    <div className="pb-4 md:pb-8 w-full md:w-40">
                      <img
                        ...
                        src={`${apiURL}/images/products/${item.productImage}`}
                    ...
                    <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                      <div className="w-full flex flex-col justify-start items-start space-y-8">
                        <h3 className="text-xl dark:text-gray-800 xl:text-2xl font-semibold leading-6 text-gray-800">
                          {item.productName}
                        </h3>
                      ...
                      <div className="flex justify-between space-x-8 items-start w-full">
                        <p className="text-base  xl:text-lg leading-6">
                          {item.productSalePrice}Dh{" "}
                          <span className="text-orange-500 line-through">
                            {" "}
                            {item.productRegularPrice}Dh
                          </span>
                        </p>
                        <p className="text-base dark:text-gray-800 xl:text-lg leading-6 text-gray-800">
                          {item.quantity} Pcs
                        </p>
                        <p className="text-base dark:text-gray-800 xl:text-lg font-semibold leading-6 text-gray-800">
                          {item.subtotal}Dh
                        </p>
                      </div>
                    </div>
              ...
              <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 dark:bg-white space-y-6">
                ...
                <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                  <div className="flex justify-between w-full">
                    <p className="text-base dark:text-gray-800 leading-4 text-gray-800">
                      Subtotal
                    </p>
                    <p className="text-base dark:text-gray-600 leading-4 text-gray-600">
                      {orders.subtotal}Dh
                    </p>
                  </div>
                  <div className="flex justify-between items-center w-full">
                    ...
                    <p className="text-base dark:text-orange-500 leading-4 text-orange-500">
                      Free
                    </p>
                  </div>
                </div>
                <div className="flex justify-between items-center w-full">
                  <p className="text-base dark:text-gray-800 font-semibold leading-4 text-gray-800">
                    Total
                  </p>
                  <p className="text-base dark:text-gray-600 font-semibold leading-4 text-gray-600">
                    {orders.subtotal}Dh
                  </p>
                </div>
              </div>
                ...
                <div className="flex justify-between items-start w-full">
                  <div className="flex justify-center items-center space-x-4">
                    ...
                    <div className="flex flex-col justify-start items-center">
                      <p className="text-lg leading-6 dark:text-gray-800 font-semibold text-gray-800">
                        DPD Delivery
                        <br />
                  ...
                  <p className="text-lg font-semibold leading-6 dark:text-orange-500 text-orange-500">
                    Free
                  </p>
                </div>
                <div className="w-full flex justify-center items-center">
                  <button className=" dark:bg-orange-500 dark:text-gray-200  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 py-5 w-96 md:w-full bg-gray-800 text-base font-medium leading-4 text-gray-200">
