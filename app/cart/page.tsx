...
export default function Page() {
  ...
  const updateQuantity = (itemId: number | null, newQuantity: number) => {
    if (itemId !== null) {
      fetch(`${apiURL}/api/shoppingCart/${itemId}/${uuid}`, {
        method: "PUT",
        headers: {
...
const deleteProductFromCart = async (idshopcartItem: number) => {
  try {
    const response = await fetch(
      `${apiURL}/api/shoppingCart/${idshopcartItem}/${uuid}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
                    ...
                    <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                      ...
                      <div className=" flex  sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                        <div className="flex items-center border-gray-100">
                          <span
                            onClick={() =>
                              decrementQuantity(cartIndex, itemIndex)
                            }
                          ...
                          <span
                            onClick={() =>
                              incrementQuantity(cartIndex, itemIndex)
                            }
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <svg
                            onClick={() =>
                              resetQuantityToOne(cartIndex, itemIndex)
                            }
        ...
        0 ? (
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
            <div className="mb-2 flex justify-between">
              ...
              <p className="text-gray-700">{subtotal}DH</p>
            </div>
